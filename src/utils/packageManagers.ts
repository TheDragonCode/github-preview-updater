...
export const getComposer = (config: Config): Package => <Package>JSON.parse(readFile(config, 'composer.json'))
export const getNpm = (config: Config): Package => <Package>JSON.parse(readFile(config, 'package.json'))
